...
describe('/skillGroup', function() {
    ...
    beforeEach(function(done) {
        ...
        cacheHandler.setToRoleAttributesCache('admin', ['canEditSkillGroup']);
        done();
    });
    ...
    it('should correctly extract the needed properties and reply with HTTP status code 200 and a correctly formatted string when posting a SkillGroup with too many fields in the body', function(done) {
